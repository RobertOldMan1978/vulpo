...
| A14 | **Vocabulario en 3°: VA, con 60 preguntas** (decidido el 31/08; la medición proponía 120 y Roberto lo bajó a la mitad, justamente porque se solapa con `LE03 OA 10` y `OA 11`, que ya tienen 30 preguntas cada uno). El ángulo que no se pisa son **las palabras nuevas de Ciencias e Historia de 3°**, distinto de *la estrategia* para deducirlas. Cuesta 60 preguntas + su aprobación + ~300 clips de voz (~US$0,2). El código ya está en el fork: es dato, como en 7° | ~1 sesión | contenido |
