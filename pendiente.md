...
- **Sitio publicado: 729 MB** (techo de GitHub Pages: 1 GB), remedido el 06/09 tras generar la voz
  de 4°. `assets/` completo son 827 MB: 589 MB de voz (3° y 4°, 6+4 asignaturas — 4° sumó 326 MB,
...
| **A46** | ⏳ **Regenerar los 42 clips mal locutados de Matemática de 4°.** El normalizador **no traducía el signo de dividir** (Sesión 104), así que esas preguntas se locutaron con el símbolo crudo y el niño oye *"36 … 1"* sin la operación. El script ya está corregido; falta borrarlos del manifiesto y regenerarlos — el clip viejo no se invalida solo, porque **el manifiesto se indexa por el texto MOSTRADO** y cambiar cómo se PRONUNCIA algo lo deja sonando igual, en silencio. **US$0,04 de la cuenta Azure de Roberto**, así que **espera su autorización explícita** | 10 min | voz |
...
2. **La precarga cache-first que proponen es inviable.** `assets/` son 827 MB (06/09), de los
   cuales **589 MB son la voz de 3° y 4°**: cachearlo todo en el `install` le bajaría cientos de
