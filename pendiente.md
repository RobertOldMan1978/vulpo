...
| **A49** | ⏳ **ABIERTA — lo que queda del panel del profesor.** Salieron de mirarlo con un doble de Supabase (Sesión 106). ~~(a) bajar el registro visual~~ ✅ **HECHA el 07/09** (ver A50). Quedan tres, y las tres dependían de esa: **(a) Una franja de "qué necesita tu atención" al entrar** —*7 alumnos no han entrado esta semana · 3 objetivos bajo 70% · 1 refuerzo sin cerrar*—, cada línea enlazando a su acción: hoy el panel abre en una lista de cursos plegados y no dice qué hacer. Es la diferencia entre una base de datos y una herramienta. **(b) La participación como titular de la tarjeta del curso**: *"15/22 jugaron esta semana"* es la línea más valiosa de esa tarjeta y **no dice si 15 de 22 está bien o mal**. ~~**(c) Exportar o imprimir el mapa**~~ ✅ **RESUELTA el 08/09 para la vista de dirección** (ver A53): el pulso del colegio se imprime en una hoja, con el primer `@media print` del proyecto. El **mapa de un curso** sigue sin salir de la pantalla, y ahora la maquinaria está hecha. ⚠️ Y la advertencia que vale para las tres: **el panel está en producción y es la pantalla que se muestra para vender.** Los cambios visuales son seguros; los de flujo piden cuidado, porque hay cuatro roles y lo que un profe de asignatura no debe ver está resuelto en el servidor *y* en la interfaz | abierta | código |
...
| **A55** | ⏳ **ABIERTA — el informe de cierre de unidad y de fin de año (fase 3).** Con las fechas puestas (A54) y las fotos semanales, falta la pantalla que las usa: *"cómo quedó la Unidad 2 cuando la cerré en junio"*, reconstruido de la foto del domingo más cercano, y su equivalente a fin de año. Es lo que hace que el módulo pueda seguir abierto sin que los informes se contaminen. ⚠️ **Con un límite que hay que decirle a un colegio antes de prometerlo:** la primera foto es del **30/08/2026**, así que de una unidad cerrada antes no se puede reconstruir nada —ese historial no existe y no se puede fabricar—. Para el año escolar 2027 habría el año completo desde marzo | abierta | código + backend |
