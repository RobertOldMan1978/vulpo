...
| 8° | 80 | 2.644 (+222 apoyo) | 2.314 · **330 pendientes** (Lenguaje, Sesión 99) | no lleva | ✅ portadas 20/20 | ✅ | ✅ |

- **16.625 preguntas escritas · 16.293 aprobadas · 332 pendientes**, y **151 lecciones · 130
  aprobadas**. Los seis cursos llegan a un alumno. **Lo pendiente es contenido recién escrito, no
  una firma que se cayó**: 330 son las de Lenguaje de 8° (Sesión 99, que completó sus 11 OA
  faltantes) y 2 son las de geometría reescritas en la Sesión 100 — al cambiarles el texto, la
  firma anterior dejó de corresponderles.
- **VULPO se anuncia desde 3° a 8° básico (06/09/2026), y desde ese mismo día los SEIS cursos
  ...
  7°, 8°) con los números reales: **16.293 preguntas aprobadas, 529 objetivos medidos**, 6 cursos
  completos, y dice que hay 332 en revisión en vez de afirmar un 100% que dejó de ser cierto.
