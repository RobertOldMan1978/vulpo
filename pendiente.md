...
- **16.625 preguntas escritas · 16.625 aprobadas**, y **151 lecciones · 151 aprobadas**. Los seis
  cursos llegan a un alumno con todo su contenido firmado. ⚠️ **Es una foto, no un estado**: la
  Sesión 99 sumó 330 preguntas y 21 lecciones, y la 100 reescribió 2 de geometría —al cambiarles
  el texto, su firma anterior dejó de corresponderles—, así que el banco estuvo en 16.293 hasta
  que Roberto firmó esas 332 + 21 el mismo 06/09. **Cada tanda nueva vuelve a la cola, y el
...
- **VULPO se anuncia desde 3° a 8° básico (06/09/2026), y desde ese mismo día los SEIS cursos
  ...
  7°, 8°) con los números reales: **16.625 preguntas aprobadas, 529 objetivos medidos** y 6 cursos
  completos.
- **Sitio publicado: 721 MB** (techo de GitHub Pages: 1 GB), remedido el 06/09 tras generar la voz
  de 4°. `assets/` completo son 820 MB: 582 MB de voz (3° y 4°, 6+4 asignaturas — 4° sumó 326 MB,
...
2. **La precarga cache-first que proponen es inviable.** `assets/` son 820 MB (06/09), de los
   cuales **582 MB son la voz de 3° y 4°**: cachearlo todo en el `install` le bajaría cientos de
