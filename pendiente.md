...
- **16.865 preguntas escritas · 16.865 aprobadas**, y **172 lecciones · 172 aprobadas**. Los seis
...
- **Paridad de funcionalidad entre los seis forks: completa donde corresponde.** Los seis
  ...
  no código**, y va como bandera. Medido el 07/09 — **172 lecciones**, que son las mismas que
  cuenta el tablero (Historia pasó de 12 a **33**: todos sus capítulos llevan introducción):
...
| **A44** | **Completar las mini-clases e introducciones que faltan.** Tras cerrar Historia quedan: **Ciencias de 4° y 6°** (10 introducciones, una por capítulo) y **Lenguaje** (13 capítulos sin lección en los seis cursos). ⚠️ **Matemática de 4° y 6° es tanda aparte por tamaño**: son **51 mini-clases** —cada una con diagrama interactivo, ejemplo paso a paso y práctica de 10— y además esos dos cursos **no tienen el camino enseña→desafío**, así que hay que reestructurar sus campañas como hizo la Sesión 98 con los otros cuatro | pendiente | contenido |
