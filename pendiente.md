...
- **Backend (07/09):** los códigos de los seis cursos en las dos listas de
  ...
  **`kimun_prof_tendencia` aplicada y comprobada** —responde `no_autorizado` a un anónimo,
  ...
  ⚠️ **Y hay un cambio SIN APLICAR: `kimun_prof_ranking_general`** (07/09), la pestaña
  "General" del ranking. Hasta que se re-aplique, esa pestaña dice *"no se pudo cargar"*;
  las cuatro por asignatura y el mapa funcionan igual.
