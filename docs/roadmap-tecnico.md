...
| Carpeta | Peso |
|---|---|
| `assets/voz/` (voz pregrabada de 3° y 4°) | **589 MB** en bytes reales — 6+4 asignaturas |
...
| **Sitio publicado** (sin `.git` ni `originales`, ya excluidos) | **729 MB** |
...
optimización: es un motivo para desinstalar. Y con el sitio ya en 729 MB de 1 GB, **no queda
