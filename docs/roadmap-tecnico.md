...
| Carpeta | Peso |
|---|---|
| `assets/voz/` (voz pregrabada de 3° y 4°) | **602 MB** en bytes reales — 6+4 asignaturas |
...
| **Sitio publicado** (sin `.git` ni `originales`, ya excluidos) | **742 MB** |
...
optimización: es un motivo para desinstalar. Y con el sitio ya en 742 MB de 1 GB, **no queda
