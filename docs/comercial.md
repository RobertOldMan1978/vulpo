...
**Sí:** 4 asignaturas por curso en 3°, 4°, 5°, 6°, 7° y 8° básico —**16.865 preguntas aprobadas**,
...
- ⚠️ **No decir "una a una".** Hoy sí está aprobado el 100% del banco (16.865 de 16.865), pero lo
  ...
  **muestreo** de 8 de cada 30, así que la cobertura no es el método. Y **el 100% es una foto, no
  ...
  06/09 estuvo en 16.293 de 16.625 durante unas horas, y el 07/09 en 16.625 de 16.865 mientras se
  firmaba el Vocabulario nuevo—. Exagerarlo se cae a la primera pregunta de
...
**Y la marca está en trámite, no registrada.** La solicitud de VULPO se presentó y pagó en INAPI
el 07/09 a nombre de la SpA (la prioridad corre desde esa fecha), y ya está **publicada en el
Diario Oficial** (informado el 12/09), con el plazo de oposición de terceros corriendo.
...
> ingresada con prioridad desde el 07/09 y ya publicada en el Diario Oficial— y eso ya es una
> respuesta sólida, más aún que "presentada".
