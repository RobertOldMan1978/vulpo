...
ciclo básico.
→ **Formulación segura:** *"las plantas liberan oxígeno cuando reciben luz del Sol"*. Evitar
la palabra "respirar" referida a la planta en todo el banco. **No preguntar qué pasa de
noche**: eso es de 7°.

**2. Las plantas "se alimentan del suelo".**
La planta **fabrica su propio alimento**; del suelo toma agua y minerales, que no son
alimento.
...
conductas de riesgo alimentario; en Chile además cruza con nivel socioeconómico.
→ **Formulación segura:** *de consumo **diario** / de consumo **ocasional*** —el lenguaje del
MINEDUC y del MINSAL—, o clasificar por **grupo** (frutas, lácteos, cereales) y por
...
→ **Obligatorio:** toda pregunta o `tip` que mencione un eclipse de Sol debe decir que
**nunca se mira directo** —ni con lentes de sol, ni con radiografías, solo con lentes
certificados—. Ninguna pregunta puede sugerir observar el Sol como actividad.
...
distractor está bien **solo si el `tip` lo explica**. La Luna es un **satélite**, no un
planeta; el Sol es una **estrella**, no un planeta.

**7. Las estaciones NO se deben a la distancia al Sol.** *"En verano estamos más cerca"* es
...
sombra"* es **falso**: eso es un eclipse lunar. Las fases dependen de qué parte iluminada de
la Luna vemos según su posición.
...
→ Apoyarse en el experimento del propio OA: el teléfono de cuerda funciona porque el sonido
se transmite por el hilo (sólido).

**11. Absorber ≠ reflejar.** Una alfombra apaga el sonido porque lo **absorbe**; un muro lo
**refleja** (eco). El OA nombra ambos: no usarlos como sinónimos en los `tip`.
...
introducidas. Confundirlos enseña algo falso sobre el propio país.

**13. Hábitat.** *"El cactus vive en el desierto porque no necesita agua"* es falso: sí
