...
> **Al 10/09/2026 queda UNA fila pendiente: `kimun_prof_cursos` (el helper del mantenedor, Fase 3).**
> Roberto la re-aplica tras el commit del mantenedor. La Fase 2 del motor granular (las dos filas de
> arriba) ya está aplicada y comprobada con el control positivo/negativo verde y el conteo de la
> migración. Todo lo demás también está aplicado.
>
