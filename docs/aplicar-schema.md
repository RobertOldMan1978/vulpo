...
> **Al 08/09/2026 el backend NO tiene nada pendiente.** Todo está aplicado y comprobado, incluido
> el portero de `kimun_prof_resumen`, que se re-pegó el mismo día (fila de arriba).
>
