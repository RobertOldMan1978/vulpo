...
> **Al 08/09/2026 no queda ninguna fila pendiente de aplicar.** `kimun_mi_plan` (el semáforo del
> alumno, última fila) se aplicó y comprobó ese mismo día con sus tres controles. Todo lo anterior
> también está aplicado, incluido el portero de `kimun_prof_resumen`.
>
